...
public class TextTriangleParserTest {
    ...
    private Object[][] provideInvalidTextFormatTriangle() {
        return new Object[][]{
                ...
                {"Invalid delimiter", Arrays.asList("1", "2,3", "4, 5")},
                {"Non-integer weights", Collections.singletonList(Long.MAX_VALUE)},
        };
    }
    ...
    public void parse_validTextFormatTriangle_shouldConstructValidGraph() {
        ...
        final Map<Integer, WeightedVertex> r1v7NeighboursByWeight = graphTestWrapper.getNeighbourListOfByWeight(r1v7.get());
        Assertions.assertThat(r1v7NeighboursByWeight)
                .hasSize(2)
                .hasEntrySatisfying(6, v -> WeightedVertexAssert.assertThat(v).hasDefinedId().hasWeight(6).hasLabel("6"))
                .hasEntrySatisfying(3, v -> WeightedVertexAssert.assertThat(v).hasDefinedId().hasWeight(3).hasLabel("3"));

        // row 2
        final Map<Integer, WeightedVertex> r2v6NeighboursByWeight = graphTestWrapper.getNeighbourListOfByWeight(r1v7NeighboursByWeight.get(6));
        Assertions.assertThat(r2v6NeighboursByWeight)
                .hasSize(2)
                .hasEntrySatisfying(3, v -> WeightedVertexAssert.assertThat(v).hasDefinedId().hasIdNotEqualTo(r1v7NeighboursByWeight.get(3).getId()).hasWeight(3).hasLabel("3"))
                .hasEntrySatisfying(8, v -> WeightedVertexAssert.assertThat(v).hasDefinedId().hasWeight(8).hasLabel("8"));

        final Map<Integer, WeightedVertex> r2v3NeighboursByWeight = graphTestWrapper.getNeighbourListOfByWeight(r1v7NeighboursByWeight.get(3));
        Assertions.assertThat(r2v3NeighboursByWeight)
                .hasSize(2)
                .hasEntrySatisfying(8, v -> WeightedVertexAssert.assertThat(v).hasDefinedId().hasWeight(8).hasLabel("8"))
                .hasEntrySatisfying(5, v -> WeightedVertexAssert.assertThat(v).hasDefinedId().hasWeight(5).hasLabel("5"));

        // row 3
        final Map<Integer, WeightedVertex> r3v3NeighboursByWeight = graphTestWrapper.getNeighbourListOfByWeight(r2v6NeighboursByWeight.get(3));
        Assertions.assertThat(r3v3NeighboursByWeight)
                .hasSize(2)
                .hasEntrySatisfying(11, v -> WeightedVertexAssert.assertThat(v).hasDefinedId().hasWeight(11).hasLabel("11"))
                .hasEntrySatisfying(2, v -> WeightedVertexAssert.assertThat(v).hasDefinedId().hasWeight(2).hasLabel("2"));

        final Map<Integer, WeightedVertex> r3v8NeighboursByWeight = graphTestWrapper.getNeighbourListOfByWeight(r2v6NeighboursByWeight.get(8));
        Assertions.assertThat(r3v8NeighboursByWeight)
                .hasSize(2)
                .hasEntrySatisfying(2, v -> WeightedVertexAssert.assertThat(v).hasDefinedId().hasWeight(2).hasLabel("2"))
                .hasEntrySatisfying(10, v -> WeightedVertexAssert.assertThat(v).hasDefinedId().hasWeight(10).hasLabel("10"));

        final Map<Integer, WeightedVertex> r3v5NeighboursByWeight = graphTestWrapper.getNeighbourListOfByWeight(r2v6NeighboursByWeight.get(5));
        Assertions.assertThat(r3v8NeighboursByWeight)
                .hasSize(2)
                .hasEntrySatisfying(10, v -> WeightedVertexAssert.assertThat(v).hasDefinedId().hasWeight(10).hasLabel("10"))
                .hasEntrySatisfying(9, v -> WeightedVertexAssert.assertThat(v).hasDefinedId().hasWeight(9).hasLabel("9"));
    }
